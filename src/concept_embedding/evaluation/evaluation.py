from src.utils.ontology_generator import ICD_Ontology as icd
from src.utils.ontology_generator import CCS_Ontology as ccs
...
class ConceptEvaluation():
    ...
    def initialize(self, cfg):
        self.verbose = cfg.globals["verbose"]

        self.icd_file = cfg.evaluation["icd_file"]
        self.ccs_file = cfg.evaluation["ccs_file"]
        self.valid_samples = cfg.evaluation["valid_examples"]
        self.top_k = cfg.evaluation["top_k"]
