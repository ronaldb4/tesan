...
from src.__refactored__.concept_embedding.models.attention_mechanisms.attention import \
...
class BaseModel(ModelTemplate):
    def __init__(self,scope,dataset):
        super(BaseModel, self).__init__(scope, dataset)
