...
class Configs(object):
    def __init__(self):
        ...
        self.icd_file = join(self.project_dir, 'src/__refactored__/utils/ontologies/D_ICD_DIAGNOSES.csv')
        self.ccs_file = join(self.project_dir, 'src/__refactored__/utils/ontologies/SingleDX-edit.txt')
        ...
        if self.is_date_encoding:
            self.processed_name = '_'.join([self.model, self.data_source,str(self.skip_window),'date_encoding'])+'.pickle'
