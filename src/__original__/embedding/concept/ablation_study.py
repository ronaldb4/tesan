...
from src.__original__.nn_utils.attention import scaled_tanh
from src.__original__.nn_utils.general import exp_mask_for_high_rank, mask_for_high_rank
from src.__original__.nn_utils.nn import linear, dropout, bn_dense_layer


###########################################################################
# identical to definition in attention.py
###########################################################################
...
#############################################################################################
# differs from similarly named in attention.py - only this one used, so moved to attention.py
#############################################################################################
