...
python ../train_prediction.py --model tesan --configSet concept_embedding/mimic_paper.json
python ../train_prediction.py --model tesa --configSet concept_embedding/mimic_paper.json
python ../train_prediction.py --model cbow --configSet concept_embedding/mimic_paper.json
python ../train_prediction.py --model skip_gram --configSet concept_embedding/mimic_paper.json
python ../train_prediction.py --model delta --configSet concept_embedding/mimic_paper.json
python ../train_prediction.py --model sa --configSet concept_embedding/mimic_paper.json
python ../train_prediction.py --model normal --configSet concept_embedding/mimic_paper.json
python ../train_prediction.py --model random_interval --configSet concept_embedding/mimic_paper.json
