...
class Configs(object):
    def __init__(self):
        ...
        self.icd_file = join(self.project_dir, 'src__original__/utils/ontologies/D_ICD_DIAGNOSES.csv')
        self.ccs_file = join(self.project_dir, 'src__original__/utils/ontologies/SingleDX-edit.txt')

        self.dataset_dir = join(self.project_dir, 'dataset', 'processed')
        self.standby_log_dir = self.mkdir(self.project_dir, 'logs__original__')
        self.result_dir = self.mkdir(self.project_dir, 'outputs__original__')
        self.all_model_dir = self.mkdir(self.result_dir, 'tasks/src__original__')
